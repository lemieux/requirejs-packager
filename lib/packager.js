...
function TreeEntry(dependencies, usedBy) {
...
TreeEntry.prototype = {
    ...
    clone: function() {
        return new TreeEntry(_.cloneDeep(this.dependencies), _.cloneDeep(this.usedBy));
    }
};
...
_.extend(Packager.prototype, {
    _buildTree: function(rawTree) {
        ...
        _.forIn(rawTree, function(dependencies, id) {
            tree[id] = this._buildTreeEntry(dependencies, []);
        }, this);
    ...
    _buildTreeEntry: function(dependencies, usedBy) {
        return new TreeEntry(dependencies, usedBy);
    },
